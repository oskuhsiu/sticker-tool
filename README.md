...
does not silently remove frames to satisfy the 1 MB limit. The raw-visual thumbnail selector can be collapsed while keeping the active correction editor visible. Adjacent equal final visuals are coalesced,
